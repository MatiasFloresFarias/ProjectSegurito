...
<head>
	...
	<title>Registrar Capacitacion</title>
	<!-- Css de boostrap -->
						...
						<tr>
							...
							<td>
								<a class="btn btn-warning"
									href="${pageContext.request.contextPath}/EditarCapacitacion?id=${capacitacion.getId_capacitacion()}">Editar</a>
								<a class="btn btn-danger"
									href="${pageContext.request.contextPath}/EliminarCapacitacion?id=${capacitacion.getId_capacitacion()}">Eliminar</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
